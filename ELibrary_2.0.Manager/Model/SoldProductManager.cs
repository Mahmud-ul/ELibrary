...
{
    public class SoldProductManager : BaseManager<SoldProduct>, ISoldProductManager
    {
        public SoldProductManager(ISoldProductRepository repository) : base(repository)
        {
        }
    }
}
