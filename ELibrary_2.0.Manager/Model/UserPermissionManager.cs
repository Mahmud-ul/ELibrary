...
{
    public class UserPermissionManager : BaseManager<UserPermission>, IUserPermissionManager
    {
        public UserPermissionManager(IUserPermissionRepository repository) : base(repository)
        {
        }
    }
}
